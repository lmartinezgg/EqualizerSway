// src/lib.rs
/*
 * Core library for EqualizerSway
 */
...
#[derive(Debug)]
pub struct EqualizerSwayProcessor {
    verbose: bool,
    processed_count: usize,
}

impl EqualizerSwayProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EqualizerSway processing");
    
    let mut processor = EqualizerSwayProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EqualizerSwayProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EqualizerSwayProcessor::new(false);
